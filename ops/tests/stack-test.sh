...
grep -Fq 'header_up Host aichor.localhost:443' "$tmp/aichor-worker-2/config/routes.d/aichor.caddy"
grep -Fq 'header_up X-Forwarded-Host aichor.localhost' "$tmp/aichor-worker-2/config/routes.d/aichor.caddy"
