...
grep -q '^ENABLED=false$' "$repo_root/config/cluster/apps/aichor3.policy"
...
grep -Fq 'chown -R 1000:1000 "$home/.paseo" "$home/.pi"' "$repo_root/apps/paseo/entrypoint-common.sh"
