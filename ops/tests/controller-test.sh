...
grep -q '^EPHEMERAL_DATA_REL=.paseo/runtime$' "$repo_root/apps/aichor/manifest.env"
...
grep -Fq '.aichor-ownership-v1' "$repo_root/apps/aichor/compose.yml"
...
grep -Fq 'header_up Host {$NODE_AICHOR_ORIGIN_HOST}' "$repo_root/apps/aichor/route.follower.caddy"
