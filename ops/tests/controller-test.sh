...
grep -q '^NODE_SECRET_KEYS=AICHOR3_PASSWORD$' "$repo_root/apps/aichor3/manifest.env"
...
grep -q '^NODE_SECRET_KEYS=AICHOR_PASSWORD$' "$repo_root/apps/aichor/manifest.env"
