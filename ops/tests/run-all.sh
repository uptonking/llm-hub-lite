...
fast)
	...
	tests=(
		...
		aichor-release-test aichor-runtime-test paseo-runtime-test aichor-pi-config-test cursorapi-release-test woodpecker-agent-repair-test woodpecker-webhook-repair-test woodpecker-plan-test workflow-generator-test bootstrap-policy-test
	)
	;;
full)
	tests=(
		...
		controller-test aichor-release-test aichor-runtime-test paseo-runtime-test aichor-pi-config-test cursorapi-release-test deployment-rollback-test
		enroll-beszel-test firewall-test git-auth-test ip-privacy-test
		observer-ingest-test observer-log-proxy-test observer-vector-test
