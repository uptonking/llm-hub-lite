...
projects=(foundation-caddy foundation-beszel-controller foundation-beszel-worker
	...
	app-aichorouter app-cpapi app-pigeon app-wabase)
containers=() networks=(platform_edge foundation-woodpecker_private foundation-observer_private app-librechat_private
	app-newapi_private app-aichorouter_private app-cpapi_private app-pigeon_private app-wabase_private app-observer_private) images=(llm-hub-lite/deploy-runner:current)
